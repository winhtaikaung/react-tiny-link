...
/>`}
  ...
  url="https://www.youtube.com/watch?v=plEcjL3XZz8"
    ...
    url="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4"
        ...
        <ReactTinyLink cardSize="small" showGraphic={true} maxLine={2} minLine={1} url="https://www.iflix.com/" />
...
/>`}
  ...
  url="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4"
        ...
        <h3>Default url example</h3>
        <ReactTinyLink cardSize="large" showGraphic={true} maxLine={2} minLine={1} url="https://www.iflix.com/" />
        <h4>Default example Code</h4>
        <pre className="language-markup">
          <code>
            {` <ReactTinyLink
